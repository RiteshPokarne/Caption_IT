...
#Load YOLO Algorithm
def objdetect(img_path):
    net=cv2.dnn.readNet("captionIT/static/yolo/yolov3.weights","captionIT/static/yolo/yolov3.cfg")

    #To load all objects that have to be detected
    classes=[]
    with open("captionIT/static/yolo/coco.names","r") as f:
        read=f.readlines()
    ...
    cv2.imwrite('captionIT\static\img_obj_Detect\pan2.jpg',img)
